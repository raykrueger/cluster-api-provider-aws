...
// AWSManagedControlPlane implements a custom validation webhook for AWSManagedControlPlane.
...
func (w *AWSManagedControlPlane) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	r, ok := obj.(*ekscontrolplanev1.AWSManagedControlPlane)
	if !ok {
...
func (w *AWSManagedControlPlane) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	r, ok := newObj.(*ekscontrolplanev1.AWSManagedControlPlane)
	if !ok {
		return nil, fmt.Errorf("expected an AWSManagedControlPlane object but got %T", r)
	}
	...
	var allErrs field.ErrorList
	allErrs = append(allErrs, w.validateEKSClusterName(r)...)
	allErrs = append(allErrs, w.validateEKSClusterNameSame(r, oldAWSManagedControlplane)...)
	allErrs = append(allErrs, w.validateEKSVersion(r, oldAWSManagedControlplane)...)
	allErrs = append(allErrs, r.Spec.Bastion.Validate()...)
	allErrs = append(allErrs, w.validateAccessConfigUpdate(r, oldAWSManagedControlplane)...)
	allErrs = append(allErrs, w.validateIAMAuthConfig(r)...)
	allErrs = append(allErrs, w.validateSecondaryCIDR(r)...)
	allErrs = append(allErrs, w.validateEKSAddons(r)...)
	allErrs = append(allErrs, w.validateDisableVPCCNI(r)...)
...
func (w *AWSManagedControlPlane) ValidateDelete(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	return nil, nil
}

func (w *AWSManagedControlPlane) validateEKSClusterName(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	var allErrs field.ErrorList
...
func (w *AWSManagedControlPlane) validateEKSClusterNameSame(r *ekscontrolplanev1.AWSManagedControlPlane, old *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	var allErrs field.ErrorList
...
func (w *AWSManagedControlPlane) validateEKSVersion(r *ekscontrolplanev1.AWSManagedControlPlane, old *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
...
func (w *AWSManagedControlPlane) validateEKSAddons(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	return validateEKSAddons(r.Spec.Version, r.Spec.NetworkSpec, r.Spec.Addons, field.NewPath("spec"))
}

func validateEKSAddons(eksVersion *string, networkSpec infrav1.NetworkSpec, addons *[]ekscontrolplanev1.Addon, path *field.Path) field.ErrorList {
	var allErrs field.ErrorList
...
func (w *AWSManagedControlPlane) validateAccessConfigUpdate(r *ekscontrolplanev1.AWSManagedControlPlane, old *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	var allErrs field.ErrorList
	...
	if old.Spec.AccessConfig != nil && r.Spec.AccessConfig != nil &&
		...
		((old.Spec.AccessConfig.AuthenticationMode == ekscontrolplanev1.EKSAuthenticationModeAPIAndConfigMap && r.Spec.AccessConfig.AuthenticationMode == ekscontrolplanev1.EKSAuthenticationModeConfigMap) ||
			old.Spec.AccessConfig.AuthenticationMode == ekscontrolplanev1.EKSAuthenticationModeAPI) {
		allErrs = append(allErrs,
...
func (w *AWSManagedControlPlane) validateAccessConfigCreate(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	var allErrs field.ErrorList

	if r.Spec.AccessConfig != nil {
		if r.Spec.AccessConfig.AuthenticationMode == ekscontrolplanev1.EKSAuthenticationModeConfigMap &&
...
func (w *AWSManagedControlPlane) validateAccessEntries(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	var allErrs field.ErrorList
	...
	for i, entry := range r.Spec.AccessEntries {
		...
		if entry.Type == ekscontrolplanev1.AccessEntryTypeEC2Linux || entry.Type == ekscontrolplanev1.AccessEntryTypeEC2Windows {
		...
		for j, policy := range entry.AccessPolicies {
			if policy.AccessScope.Type == ekscontrolplanev1.AccessScopeTypeNamespace && len(policy.AccessScope.Namespaces) == 0 {
				allErrs = append(allErrs,
...
func (w *AWSManagedControlPlane) validateIAMAuthConfig(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	return validateIAMAuthConfig(r.Spec.IAMAuthenticatorConfig, field.NewPath("spec.iamAuthenticatorConfig"))
}

func validateIAMAuthConfig(cfg *ekscontrolplanev1.IAMAuthenticatorConfig, parentPath *field.Path) field.ErrorList {
	var allErrs field.ErrorList
...
func (w *AWSManagedControlPlane) validateSecondaryCIDR(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
...
func (w *AWSManagedControlPlane) validateKubeProxy(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	return validateKubeProxy(r.Spec.KubeProxy, r.Spec.Addons, field.NewPath("spec"))
}

func validateKubeProxy(kubeProxy ekscontrolplanev1.KubeProxy, addons *[]ekscontrolplanev1.Addon, path *field.Path) field.ErrorList {
	var allErrs field.ErrorList
...
func (w *AWSManagedControlPlane) validateDisableVPCCNI(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
	return validateDisableVPCCNI(r.Spec.VpcCni, r.Spec.Addons, field.NewPath("spec"))
}

func validateDisableVPCCNI(vpcCni ekscontrolplanev1.VpcCni, addons *[]ekscontrolplanev1.Addon, path *field.Path) field.ErrorList {
	var allErrs field.ErrorList
...
func (w *AWSManagedControlPlane) validateRestrictPrivateSubnets(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
...
func (w *AWSManagedControlPlane) validatePrivateDNSHostnameTypeOnLaunch(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
...
func (w *AWSManagedControlPlane) validateNetwork(r *ekscontrolplanev1.AWSManagedControlPlane) field.ErrorList {
...
func (w *AWSManagedControlPlane) Default(_ context.Context, obj runtime.Object) error {
	r, ok := obj.(*ekscontrolplanev1.AWSManagedControlPlane)
	if !ok {
